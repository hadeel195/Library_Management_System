...
class Add(Tk):
    def __init__(self):
        ...
        Entry(self, textvariable=a, width=30).place(x=230, y=232)
        Label(self, text='Discription:', font=('Comic Scan Ms', 10, 'bold')).place(x=100, y=260)
        Entry(self, textvariable=b, width=30).place(x=230, y=262)
        Label(self, text='Status:', font=('Comic Scan Ms', 10, 'bold')).place(x=100, y=300)
        Entry(self, textvariable=c, width=30).place(x=230, y=292)
